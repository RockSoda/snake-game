...
const BOARD_SIZE = 10
let PROBABILITY_OF_DIRECTION_REVERSAL_FOOD = 0.3
...
const Board = ({ isPoisonInvolved }) => {
    if (!isPoisonInvolved) PROBABILITY_OF_DIRECTION_REVERSAL_FOOD = 0
